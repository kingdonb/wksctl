...
var CRDs = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 10, 5, 16, 39, 48, 117578364, time.UTC),
		},
		"/cluster_v1alpha1_cluster.yaml": &vfsgen۰CompressedFileInfo{
			name:             "cluster_v1alpha1_cluster.yaml",
			modTime:          time.Date(2019, 10, 5, 16, 39, 48, 116830246, time.UTC),
		...
		"/cluster_v1alpha1_machine.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 10, 5, 16, 39, 48, 117053573, time.UTC),
		...
		"/cluster_v1alpha1_machineclass.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 10, 5, 16, 39, 48, 117250194, time.UTC),
		...
		"/cluster_v1alpha1_machinedeployment.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 10, 5, 16, 39, 48, 117430118, time.UTC),
		...
		"/cluster_v1alpha1_machineset.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 10, 5, 16, 39, 48, 117613533, time.UTC),
